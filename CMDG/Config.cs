namespace CMDG
{
    ...
    {
        public const string SceneName = "QuickHello"; // Select the scene to play by entering its name. Must be a class that contains a Run() method.
        ...
        ContentWiggler:     Read console contents at startup and move the characters around
        ...
        QuickHello:         "A Quick Hello" demo for Revision 2025
        */
        ...
        public const int ScreenHeight = 61;
        public const bool VisibleBorder = true;               // Visible border around the drawing area
